...
<head>
  ...
  <title>Renovaci&oacute;n cupos | SHALOM</title>
 <link href="http://fonts.googleapis.com/icon?family=Material+Icons" rel="stylesheet">
  ...
  <link href="<?php echo addLib('templates/css/layouts/page-center.css')?>" type="text/css" rel="stylesheet" media="screen,projection">
