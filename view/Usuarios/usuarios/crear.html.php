    ...
    <div class="col s12 m12 l12">
        <div class="card-panel">
            <div class="row">
                ...
                <form id="formValidatePersona" class="col s12 formValidatePersona" data-url="<?php echo crearUrl("usuarios", "usuarios", "postCrear", array('noVista'=>"noVista")) ?>" data-redirect="<?php echo crearUrl("usuarios", "usuarios", "listar") ?>" method="post" novalidate>
